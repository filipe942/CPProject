    ...
    public class SaveManager : MonoBehaviour
    {
        ...
        public static void Load()
        {
            if (HasSave())
            {
                ...
                PlayerStats.Instance.ExperiencePoints = PlayerPrefs.GetFloat("Saved_XP");
                PlayerStats.Instance.Level = PlayerPrefs.GetInt("Saved_PlayerLevel");
                PlayerStats.Instance.Points = PlayerPrefs.GetInt("Saved_Points");
